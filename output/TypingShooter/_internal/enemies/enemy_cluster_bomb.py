...
class EnemyClusterBomb(Enemy):
    ...
    def _draw_glowing_effect(self, screen):
        ...
        pygame.draw.circle(screen, utils.color("FFD712"), self.rect.center, core_size)
        ...
        pygame.draw.circle(screen, utils.color("ffffff"), self.rect.center,
                           self.bomb_activation_distance - (self.player.rect.width / 2), 1)
